 ...
 */
window.cabinetStudio.cfTexture = window.cabinetStudio.cfTexture || {};
...
(function(t){
    ...
    t.texture = function (type, options) {
    ...
    t.texture.prototype = function () {
    };
    t.texture.prototype.setMaterial = function (object, success) {

        var typeCode = t.getTypeCode(this.type);
...
}(window.cabinetStudio.cfTexture));
