...
window.cabinetstudio.Plank.prototype = {
    constructor: window.cabinetstudio.Plank,

    translate: function (xShift, yShift, zShift) {
        "use strict";
    ...
    rotateAroundXAxis: function (angleTheta) {
        "use strict";
    ...
    rotateAroundYAxis: function (angleTheta) {
        "use strict";
        // angle with yz plane
        if (angleTheta !== 0) {
            var rotationMatrix = window.cabinetstudio.utils.matrix.getIdentityMatrix(4);
    ...
    rotateAroundZAxis: function (angleTheta) {
        "use strict";
